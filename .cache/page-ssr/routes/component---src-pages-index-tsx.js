...
// EXTERNAL MODULE: external "C:\\Users\\eoeoa\\Desktop\\github\\daedaem.github.io\\node_modules\\react\\index.js"
var external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_ = __webpack_require__(4259);
...
var useInsertionEffect = external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_['useInsertion' + 'Effect'] ? external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_['useInsertion' + 'Effect'] : function useInsertionEffect(create) {
  create();
};
...
var Insertion = function Insertion(_ref) {
  ...
  if (!isBrowser$1 && rules !== undefined) {
    ...
    return /*#__PURE__*/(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.createElement)("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedNames, _ref2.dangerouslySetInnerHTML = {
      __html: rules
  ...
  return function () {
    ...
    var Styled = (0,emotion_element_570fe3bb_esm.w)(function (props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = (0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useContext)(emotion_element_570fe3bb_esm.T);
      }
      ...
      newProps.ref = ref;
      return /*#__PURE__*/(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.createElement)(external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.Fragment, null, /*#__PURE__*/(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.createElement)(Insertion, {
        cache: cache,
        serialized: serialized,
        isStringTag: typeof FinalTag === 'string'
      }), /*#__PURE__*/(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.createElement)(FinalTag, newProps));
    });
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4259);
...
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const defaultStyle= true?{name:"1l0jlid",styles:"@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+KR&display=swap');{}*{padding:0;margin:0;box-sizing:border-box;font-family:'Noto Sans KR',sans-serif;}html,body,#___gatsby{height:100%;}a,a:hover{color:inherit;text-decoration:none;cursor:pointer;}"}:0;const GlobalStyle=function(){return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .Global */ .xB,{styles:defaultStyle});};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GlobalStyle);
...
var GlobalStyle = __webpack_require__(513);
...
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const FooterWrapper=(0,emotion_styled_base_esm/* default */.Z)("footer", true?{target:"e1oae0v80"}:0)( true?{name:"9w9jmx",styles:"display:grid;place-items:center;margin-top:auto;padding:50px 0;font-size:15px;text-align:center;line-height:1.5;@media (max-width: 768px){font-size:13px;}"}:0);const Footer=function(){return (0,emotion_react_esm/* jsx */.tZ)(FooterWrapper,null,"Thank You for Visiting My Blog, Have a Good Day \uD83D\uDE04",(0,emotion_react_esm/* jsx */.tZ)("br",null),"\xA9 2021 Developer Hae-sung, Powered By Gatsby.");};/* harmony default export */ const Common_Footer = (Footer);
// EXTERNAL MODULE: ./node_modules/react-helmet/es/Helmet.js
var Helmet = __webpack_require__(4593);
;// CONCATENATED MODULE: ./src/components/Common/Template.tsx
function Template_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Container=(0,emotion_styled_base_esm/* default */.Z)("main", true?{target:"e1strnqo0"}:0)( true?{name:"13ku56z",styles:"display:flex;flex-direction:column;height:100%"}:0);const Template=function({title,description,url,image,children}){return (0,emotion_react_esm/* jsx */.tZ)(Container,null,(0,emotion_react_esm/* jsx */.tZ)(Helmet.Helmet,null,(0,emotion_react_esm/* jsx */.tZ)("title",null,title),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"description",content:description}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{httpEquiv:"Content-Type",content:"text/html;charset=UTF-8"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:type",content:"website"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:title",content:title}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:description",content:description}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:image",content:image}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:url",content:url}),(0,emotion_react_esm/* jsx */.tZ)("meta",{property:"og:site_name",content:title}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:card",content:"summary"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:title",content:title}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:description",content:description}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:image",content:image}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:site",content:"@\uC0AC\uC6A9\uC790\uC774\uB984"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"twitter:creator",content:"@\uC0AC\uC6A9\uC790\uC774\uB984"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"google-site-verification",content:"\uC6F9 \uB9C8\uC2A4\uD130 \uB3C4\uAD6C\uAC00 \uC81C\uACF5\uD558\uB294 Meta \uD0DC\uADF8"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"naver-site-verification",content:"\uC6F9 \uB9C8\uC2A4\uD130 \uB3C4\uAD6C\uAC00 \uC81C\uACF5\uD558\uB294 Meta \uD0DC\uADF8"}),(0,emotion_react_esm/* jsx */.tZ)("html",{lang:"ko"})),(0,emotion_react_esm/* jsx */.tZ)(GlobalStyle/* default */.Z,null),children,(0,emotion_react_esm/* jsx */.tZ)(Common_Footer,null));};/* harmony default export */ const Common_Template = (Template);
...
var Template = __webpack_require__(4306);
// EXTERNAL MODULE: ./node_modules/@emotion/styled/base/dist/emotion-styled-base.esm.js + 1 modules
var emotion_styled_base_esm = __webpack_require__(5858);
...
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const CategoryListWrapper=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1kn8q5k1"}:0)( true?{name:"7on4i6",styles:"display:flex;flex-wrap:wrap;width:768px;margin:100px auto 0;@media (max-width: 768px){width:100%;margin-top:50px;padding:0 20px;}"}:0);// const CategoryItem = styled(Link)`
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const CategoryItem=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(({active,...props})=>(0,emotion_react_esm/* jsx */.tZ)(gatsby_browser_entry.Link,props), true?{target:"e1kn8q5k0"}:0)("margin-right:20px;padding:5px 0;font-size:18px;font-weight:",({active})=>active?'800':'400',";cursor:pointer;&:last-of-type{margin-right:0;}@media (max-width: 768px){font-size:15px;}"+( true?"":0));const CategoryList=function({selectedCategory,categoryList}){return (0,emotion_react_esm/* jsx */.tZ)(CategoryListWrapper,null,Object.entries(categoryList).map(([name,count])=>(0,emotion_react_esm/* jsx */.tZ)(CategoryItem,{to:`/?category=${name}`,active:name===selectedCategory,key:name},"#",name,"(",count,")")));};/* harmony default export */ const Main_CategoryList = (CategoryList);
...
function ProfileImage_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const ProfileImageWrapper=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(gatsby_image_module/* GatsbyImage */.HN, true?{target:"e1n1u3tj0"}:0)( true?{name:"1on2x4e",styles:"width:120px;height:120px;margin-bottom:30px;border-radius:50%;@media (max-width: 768px){width:80px;height:80px;}"}:0);const ProfileImage=function({profileImage}){return (0,emotion_react_esm/* jsx */.tZ)(ProfileImageWrapper,{image:profileImage,alt:"Profile Image"});};/* harmony default export */ const Main_ProfileImage = (ProfileImage);
;// CONCATENATED MODULE: ./src/components/Main/Introduction.tsx
function Introduction_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Background=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e160b013"}:0)( true?{name:"1u7ncg7",styles:"width:100%;background-image:linear-gradient(60deg, #29323c 0%, #485563 100%);color:#ffffff"}:0);const Wrapper=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e160b012"}:0)( true?{name:"1kisa53",styles:"display:flex;flex-direction:column;justify-content:center;align-items:flex-start;width:768px;height:400px;margin:0 auto;@media (max-width: 768px){width:100%;height:300px;padding:0 20px;}"}:0);const SubTitle=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e160b011"}:0)( true?{name:"1h8u8jj",styles:"font-size:20px;font-weight:400;@media (max-width: 768px){font-size:15px;}"}:0);const Title=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e160b010"}:0)( true?{name:"1mgdphf",styles:"margin-top:5px;font-size:35px;font-weight:700;@media (max-width: 768px){font-size:25px;}"}:0);const Introduction=function({profileImage}){return (0,emotion_react_esm/* jsx */.tZ)(Background,null,(0,emotion_react_esm/* jsx */.tZ)(Wrapper,null,(0,emotion_react_esm/* jsx */.tZ)(Main_ProfileImage,{profileImage:profileImage}),(0,emotion_react_esm/* jsx */.tZ)("div",null,(0,emotion_react_esm/* jsx */.tZ)(SubTitle,null,"Nice to Meet You,"),(0,emotion_react_esm/* jsx */.tZ)(Title,null,"I'm Junior Frontend Developer Hae-sung."))));};/* harmony default export */ const Main_Introduction = (Introduction);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
var esm_extends = __webpack_require__(7462);
;// CONCATENATED MODULE: ./src/components/Main/PostItem.tsx
function PostItem_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const PostItemWrapper=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(gatsby_browser_entry.Link, true?{target:"e1eg5kak7"}:0)( true?{name:"m7gxp6",styles:"display:flex;flex-direction:column;border-radius:10px;box-shadow:0 0 8px rgba(0, 0, 0, 0.15);transition:0.3s box-shadow;cursor:pointer;&:hover{box-shadow:0 0 10px rgba(0, 0, 0, 0.3);}"}:0);const ThumbnailImage=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(gatsby_image_module/* GatsbyImage */.HN, true?{target:"e1eg5kak6"}:0)( true?{name:"1axbq5h",styles:"width:100%;height:200px;border-radius:10px 10px 0 0"}:0);const PostItemContent=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak5"}:0)( true?{name:"1do7u82",styles:"flex:1;display:flex;flex-direction:column;padding:15px"}:0);const PostItem_Title=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak4"}:0)( true?{name:"kw2b4d",styles:"display:-webkit-box;overflow:hidden;margin-bottom:3px;text-overflow:ellipsis;white-space:normal;overflow-wrap:break-word;-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:20px;font-weight:700"}:0);const PostItem_Date=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak3"}:0)( true?{name:"xm5j9w",styles:"font-size:14px;font-weight:400;opacity:0.7"}:0);const Category=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak2"}:0)( true?{name:"1bobky6",styles:"display:flex;flex-wrap:wrap;margin-top:10px;margin:10px -5px"}:0);const PostItem_CategoryItem=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak1"}:0)( true?{name:"1bzcbme",styles:"margin:2.5px 5px;padding:3px 5px;border-radius:3px;background:black;font-size:14px;font-weight:700;color:white"}:0);const Summary=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e1eg5kak0"}:0)( true?{name:"1wehmme",styles:"display:-webkit-box;overflow:hidden;margin-top:auto;text-overflow:ellipsis;white-space:normal;overflow-wrap:break-word;-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:16px;opacity:0.8"}:0);const PostItem=function({title,date,categories,summary,thumbnail:{childImageSharp:{gatsbyImageData}},link}){return (0,emotion_react_esm/* jsx */.tZ)(PostItemWrapper,{to:link},(0,emotion_react_esm/* jsx */.tZ)(ThumbnailImage,{image:gatsbyImageData,alt:"Post Item Image"}),(0,emotion_react_esm/* jsx */.tZ)(PostItemContent,null,(0,emotion_react_esm/* jsx */.tZ)(PostItem_Title,null,title),(0,emotion_react_esm/* jsx */.tZ)(PostItem_Date,null,date),(0,emotion_react_esm/* jsx */.tZ)(Category,null,categories.map(item=>(0,emotion_react_esm/* jsx */.tZ)(PostItem_CategoryItem,{key:item},item))),(0,emotion_react_esm/* jsx */.tZ)(Summary,null,summary)));};/* harmony default export */ const Main_PostItem = (PostItem);
;// CONCATENATED MODULE: ./src/hooks/useInfiniteScroll.tsx
const NUMBER_OF_ITEMS_PER_PAGE=10;const useInfiniteScroll=function(selectedCategory,posts){const containerRef=(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useRef)(null);const observer=(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useRef)(null);const{0:count,1:setCount}=(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useState)(1);const postListByCategory=(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useMemo)(()=>posts.filter(({node:{frontmatter:{categories}}})=>selectedCategory!=='All'?categories.includes(selectedCategory):true),[selectedCategory]);(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useEffect)(()=>{observer.current=new IntersectionObserver((entries,observer)=>{if(!entries[0].isIntersecting)return;setCount(value=>value+1);observer.unobserve(entries[0].target);});},[]);(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useEffect)(()=>setCount(1),[selectedCategory]);(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useEffect)(()=>{if(NUMBER_OF_ITEMS_PER_PAGE*count>=postListByCategory.length||containerRef.current===null||containerRef.current.children.length===0||observer.current===null)return;observer.current.observe(containerRef.current.children[containerRef.current.children.length-1]);},[count,selectedCategory]);return{containerRef,postList:postListByCategory.slice(0,count*NUMBER_OF_ITEMS_PER_PAGE)};};/* harmony default export */ const hooks_useInfiniteScroll = (useInfiniteScroll);
;// CONCATENATED MODULE: ./src/components/Main/PostList.tsx
function PostList_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const PostListWrapper=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"es8e92y0"}:0)( true?{name:"11grurp",styles:"display:grid;grid-template-columns:1fr 1fr;grid-gap:20px;width:768px;margin:0 auto;padding:50px 0 100px;@media (max-width: 768px){grid-template-columns:1fr;width:100%;padding:50px 20px;}"}:0);const PostList=function({selectedCategory,posts}){const{containerRef,postList}=hooks_useInfiniteScroll(selectedCategory,posts);return (0,emotion_react_esm/* jsx */.tZ)(PostListWrapper,{ref:containerRef},postList.map(({node:{id,fields:{slug},frontmatter}})=>(0,emotion_react_esm/* jsx */.tZ)(Main_PostItem,(0,esm_extends/* default */.Z)({},frontmatter,{link:slug,key:id}))));};// export type PostType = {
//   node: {
//     id: string
//     frontmatter: {
//       title: string
...
const IndexPage=function({location:{search},data:{site:{siteMetadata:{title,description,siteUrl}},allMarkdownRemark:{edges},file:{childImageSharp:{gatsbyImageData},publicURL}}}){const parsed=query_string.parse(search);const selectedCategory=typeof parsed.category!=='string'||!parsed.category?'All':parsed.category;const categoryList=(0,external_C_Users_eoeoa_Desktop_github_daedaem_github_io_node_modules_react_index_js_.useMemo)(()=>edges.reduce((list,{node:{frontmatter:{categories}}})=>{categories.forEach(category=>{if(list[category]===undefined)list[category]=1;else list[category]++;});list['All']++;return list;},{All:0}),[]);return (0,emotion_react_esm/* jsx */.tZ)(Template/* default */.Z,{title:title,description:description,url:siteUrl,image:publicURL},(0,emotion_react_esm/* jsx */.tZ)(Main_Introduction,{profileImage:gatsbyImageData}),(0,emotion_react_esm/* jsx */.tZ)(Main_CategoryList,{selectedCategory:selectedCategory,categoryList:categoryList}),(0,emotion_react_esm/* jsx */.tZ)(Main_PostList,{selectedCategory:selectedCategory,posts:edges}));};/* harmony default export */ const pages = (IndexPage);const getPostList="138380833";
