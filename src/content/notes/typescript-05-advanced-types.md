...
> **바로잡음(2026-09-03):** 선택적 체이닝(`?.`)과 아래의 널 병합(`??`)은 타입스크립트 고유 문법이 아니라 **ES2020 자바스크립트 문법**이다. TS 3.7이 표준 확정보다 먼저 지원했을 뿐이다. 컴파일 결과도 if문이 아니라 `a === null || a === void 0 ? void 0 : a.b` 같은 **조건식**이다.
