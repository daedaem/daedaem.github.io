---
title: '스프링은 왜 만들어졌고, 객체 지향과 무슨 관계인가'
...
2000년 9월, 마틴 파울러와 동료들이 **POJO**(Plain Old Java Object)라는 말을 만들었다. 그대로 옮기면 "순수하고 오래된 자바 객체"인데, **특정 프레임워크에 종속되지 않은 자바 본래의 모습으로 돌아가자**는 메시지였다.
