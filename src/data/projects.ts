...
export const PROJECTS: Project[] = [
  {
    ...
    what: '생활체육센터의 대관 공간을 시간 단위로 조회·예약·관리하는 웹 애플리케이션을 만들려고 한다. 지금 저장소에 있는 것은 요구사항·ERD·설계 메모와 Spring Boot·React 골격뿐이다. 코드를 쓰기 전에 "같은 시간에 두 명이 동시에 누르면 어떻게 되는가"를 먼저 정하고 있고, 아래는 그 검토 내용이다.',
    points: [
      {
