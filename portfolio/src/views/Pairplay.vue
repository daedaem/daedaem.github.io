  ...
  <div class="pairplay-total-info-box">
    <div class="info-box">
      ...
      <div class="portfolio-detail-info-box">
        ...
        <div class="portfolio-detail-info-contents col">
          ...
          <div class="portfolio-detail-info-content">
            총 6명(백엔드 3명, 프론트엔드 3명)
          </div>
          <div class="portfolio-detail-info-content">
            전국 체육시설 조회, 예약 및 운동 메이트 중개 플랫폼
          </div>
          <div class="portfolio-detail-info-content">
            Javascript, Vue 3, Scss, bootstrap, Figma, Naver Map API
          </div>
          <div class="portfolio-detail-info-content">
    ...
    <div class="bottom-box">
      <div class="portfolio-detail-image-box">
        <div class="row">
          <div class="col">
            <p class="picture-title">장소 메인페이지</p>
            <img
            ...
            />
            <div class="my-5">
              <p class="picture-title">장소 검색페이지</p>
              <img
                class="portfolio-detail-image"
                src="@/assets/pairplay/pairplayPlaceSearch.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div class="col">
            <p class="picture-title">장소 상세페이지</p>
            <img
              class="portfolio-detail-image"
